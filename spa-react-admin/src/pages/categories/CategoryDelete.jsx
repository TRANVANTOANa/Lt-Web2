...
export default function CategoryDelete({ item, onConfirm, onCancel }) {
  return (
    <div className="modal-backdrop">
      <div className="modal-box" style={{ maxWidth: 440, textAlign: 'center' }}>
        ...
        <p style={{ margin: '18px 0', fontSize: 15, color: '#6b5c70' }}>Bạn có chắc chắn muốn xóa <b>{item.fullName || item.name || `#${item.id}`}</b>?</p>
