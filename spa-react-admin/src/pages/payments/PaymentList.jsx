...
export default function PaymentList({ config }) {
  ...
  return (
    <div>
      ...
      {modal && <PaymentForm fields={config.fields} initial={editing} onClose={() => setModal(false)} onSubmit={save} lookups={lookups} />}
      {deleting && <PaymentDelete item={deleting} onConfirm={handleDelete} onCancel={() => setDeleting(null)} />}
      {viewing && (
        <ViewDetailModal
