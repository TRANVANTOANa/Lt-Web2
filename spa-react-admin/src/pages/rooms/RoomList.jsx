...
import RoomDelete from './RoomDelete.jsx';
import ViewDetailModal from '../../components/ViewDetailModal.jsx';

export default function RoomList({ config }) {
  ...
  return (
    <div>
      ...
      {modal && <RoomForm fields={config.fields} initial={editing} onClose={() => setModal(false)} onSubmit={save} lookups={lookups} />}
      {deleting && <RoomDelete item={deleting} onConfirm={handleDelete} onCancel={() => setDeleting(null)} />}
      {viewing && (
        <ViewDetailModal
