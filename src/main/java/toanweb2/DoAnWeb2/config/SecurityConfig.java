    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // 2. Employees
                .requestMatchers(HttpMethod.GET, "/api/employees").hasAnyRole("ADMIN", "NHAN_VIEN")
                .requestMatchers(HttpMethod.GET, "/api/employees/*").hasAnyRole("ADMIN", "NHAN_VIEN")
                ...
                .requestMatchers("/api/customers/**").hasAnyRole("ADMIN", "NHAN_VIEN", "KHACH_HANG")

                // 4. Appointments
                .requestMatchers(HttpMethod.DELETE, "/api/appointments/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/appointments/customer/*").hasAnyRole("ADMIN", "NHAN_VIEN", "KHACH_HANG")
                .requestMatchers(HttpMethod.GET, "/api/appointments/*").hasAnyRole("ADMIN", "NHAN_VIEN", "KHACH_HANG")
                .requestMatchers(HttpMethod.POST, "/api/appointments").hasAnyRole("ADMIN", "NHAN_VIEN", "KHACH_HANG")
                .requestMatchers("/api/appointments/**").hasAnyRole("ADMIN", "NHAN_VIEN")

                // 5. Invoices
                .requestMatchers("/api/invoices/revenue/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/invoices/customer/*").hasAnyRole("ADMIN", "NHAN_VIEN", "KHACH_HANG")
                .requestMatchers(HttpMethod.GET, "/api/invoices/*").hasAnyRole("ADMIN", "NHAN_VIEN", "KHACH_HANG")
